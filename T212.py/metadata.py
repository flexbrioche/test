...
headers = {"Authorization": "1288795ZihOurnSrQawlhjLLwQRyomllwNdD"}
...
fig, ax = plt.subplots()
ax.plot(tickers, average_prices, c='green', alpha=0.5)
ax.plot(tickers, current_prices, c='red', alpha=0.5)
